...
<div class="h-screen md:flex">
    <div
        ...
        <div>
            <h1 class="text-white font-bold text-4xl font-sans">Ar-Rohmah Bogor</h1>
            {{-- <p class="text-white mt-1 text-center">Ar-Rohmah Bogor</p> --}}
            {{-- <button type="submit" class="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2"></button> --}}
            <div class="grid grid-cols-1 justify-center mt-10">
                 <p class="text-white font-extrabold text-center text-xl" id="tgl">00:00:00</p>
                 <p class="text-white font-extrabold text-center text-5xl" id="jam">00:00:00</p>
            </div>
        </div>
    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form class="bg-white">
            <h1 class="text-gray-800 font-bold text-2xl mb-1">Ahlan!</h1>
